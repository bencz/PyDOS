...
# Usage: wmake [all|compiler|runtime|test|all32|runtime32|test32|release|clean]
...
CFLAGS      = -0 -ml -ox -zq -fpc -we
CPPFLAGS    = -3s -mf -ox -zq -fpc -we
C386FLAGS   = -3s -mf -ox -zq -fpc -we -dPYDOS_32BIT
CDBGFLAGS   = -0 -ml -od -zq -fpc -we -d2 -dPYDOS_DEBUG_CMP

BIN         = bin
LIB         = lib

# CauseWay keeps PYDOS.EXE self-contained, which simplifies distribution and
# execution in DOSBox-X without a separate DOS4GW.EXE beside the compiler.
SYSTEM32     = causeway
...
RUNTIME_OBJS = &
    ...
    runtime\pdos_byt.obj &
    runtime\pdos_rng.obj &
    runtime\pdos_cod.obj &
    runtime\pdos_vm.obj
...
RUNTIME32_OBJS = &
    ...
    runtime\pdos_z32.obj &
    runtime\pdos_u32.obj &
    runtime\pdos_w32.obj &
    runtime\pdos_cd3.obj &
    runtime\pdos_vm3.obj
...
# ===========================================================================
# Compiler (PYDOS.EXE, 386 CauseWay)
# ===========================================================================
...
compiler\pbcarc.obj: compiler\pbcarc.cpp .AUTODEPEND
    $(CPP) $(CPPFLAGS) -fo=$@ compiler\pbcarc.cpp

compiler\pbclwr.obj: compiler\pbclwr.cpp .AUTODEPEND
    $(CPP) $(CPPFLAGS) -fo=$@ compiler\pbclwr.cpp

compiler: $(BIN)\PYDOS.EXE $(BIN)\STDLIB.IDX .SYMBOLIC

# Binary release assembled directly under DOS.  The Unix-hosted release
# target additionally writes helper batch files and public headers.
release: compiler runtime runtime32 .SYMBOLIC
    @if not exist release mkdir release
    @if not exist release\msdos mkdir release\msdos
    @if not exist release\msdos\bin mkdir release\msdos\bin
    @if not exist release\msdos\lib mkdir release\msdos\lib
    @copy $(BIN)\PYDOS.EXE release\msdos\bin\PYDOS.EXE >NUL
    @copy $(BIN)\STDLIB.IDX release\msdos\bin\STDLIB.IDX >NUL
    @copy $(LIB)\PYDOSRT.LIB release\msdos\lib\PYDOSRT.LIB >NUL
    @copy $(LIB)\PDOS32RT.LIB release\msdos\lib\PDOS32RT.LIB >NUL
    @echo Release written to release\msdos

$(BIN)\PYDOS.EXE: $(COMPILER_OBJS)
    %write  pydos.lnk system $(SYSTEM32)
    %append pydos.lnk name $@
    %append pydos.lnk file compiler\main.obj
    %append pydos.lnk file compiler\execmode.obj
    %append pydos.lnk file compiler\pbc.obj
    %append pydos.lnk file compiler\pbcop.obj
    %append pydos.lnk file compiler\pbcmod.obj
    %append pydos.lnk file compiler\pbcarc.obj
    %append pydos.lnk file compiler\pbclwr.obj
    ...
    %append pydos.lnk file compiler\pirhyg.obj
...
$(LIB)\PYDOSRT.LIB: $(RUNTIME_OBJS)
    ...
    %append pydosrt.lnk +runtime\pdos_tui.obj
    ...
    %append pydosrt.lnk +runtime\pdos_byt.obj
    %append pydosrt.lnk +runtime\pdos_rng.obj
    %append pydosrt.lnk +runtime\pdos_cod.obj
    %append pydosrt.lnk +runtime\pdos_vm.obj
    wlib @pydosrt.lnk
...
runtime_debug: .SYMBOLIC
    ...
    $(CC) $(CDBGFLAGS) -fo=runtime\pdos_tui.obj runtime\pdos_tui.c
    ...
    $(CC) $(CDBGFLAGS) -fo=runtime\pdos_byt.obj runtime\pdos_byt.c
    $(CC) $(CDBGFLAGS) -fo=runtime\pdos_rng.obj runtime\pdos_rng.c
    $(CC) $(CDBGFLAGS) -fo=runtime\pdos_cod.obj runtime\pdos_cod.c
...
$(LIB)\PDOS32RT.LIB: $(RUNTIME32_OBJS)
    ...
    %append pdos32rt.lnk +runtime\pdos_z32.obj
    %append pdos32rt.lnk +runtime\pdos_u32.obj
    %append pdos32rt.lnk +runtime\pdos_w32.obj
    %append pdos32rt.lnk +runtime\pdos_cd3.obj
    %append pdos32rt.lnk +runtime\pdos_vm3.obj
    wlib @pdos32rt.lnk
...
runtime\pdos_z32.obj: runtime\pdos_byt.c .AUTODEPEND
    $(CC386) $(C386FLAGS) -fo=$@ $[@

runtime\pdos_u32.obj: runtime\pdos_rng.c .AUTODEPEND
    $(CC386) $(C386FLAGS) -fo=$@ $[@

runtime\pdos_w32.obj: runtime\pdos_tui.c .AUTODEPEND
    $(CC386) $(C386FLAGS) -fo=$@ $[@

runtime\pdos_cd3.obj: runtime\pdos_cod.c .AUTODEPEND
    $(CC386) $(C386FLAGS) -fo=$@ $[@

runtime\pdos_vm3.obj: runtime\pdos_vm.c .AUTODEPEND
    $(CC386) $(C386FLAGS) -fo=$@ $[@

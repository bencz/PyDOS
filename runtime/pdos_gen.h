...
/* Return the value carried by StopIteration after generator completion. */
...
/* VM frames can safely raise the pending exception on their current C
 * stack and route it through the bytecode exception table. */

...
PyDosObj far * PYDOS_API pydos_cor_new(void (far *resume)(void), int num_locals)
{
    ...
    cor = pydos_obj_alloc_type(PYDT_COROUTINE);
    ...
    cor->v.gen.pc = 0;
    cor->v.gen.vm_stack = (PyDosObj far *)0;
    cor->v.gen.vm_closure = (PyDosObj far *)0;
    cor->v.gen.code_ref = (struct PyDosCodeRef far *)0;
    cor->v.gen.vm_suspended = 0;

...
PyDosObj far * PYDOS_API pydos_builtin_round(int argc, PyDosObj far * far *argv);
...
PyDosObj far * PYDOS_API pydos_builtin_tuple_conv(int argc, PyDosObj far * far *argv);
PyDosObj far * PYDOS_API pydos_builtin_object_conv(int argc, PyDosObj far * far *argv);
PyDosObj far * PYDOS_API pydos_builtin_memoryview(int argc,
                                                  PyDosObj far * far *argv);
PyDosObj far * PYDOS_API pydos_builtin_dict_conv(int argc, PyDosObj far * far *argv);
PyDosObj far * PYDOS_API pydos_builtin_set_conv(int argc, PyDosObj far * far *argv);
PyDosObj far * PYDOS_API pydos_builtin_set_empty(int argc, PyDosObj far * far *argv);
...
PyDosObj far * PYDOS_API pydos_builtin_delattr(int argc, PyDosObj far * far *argv);
PyDosObj far * PYDOS_API pydos_builtin_callable(int argc, PyDosObj far * far *argv);
/* Internal protocol primitive used by the Python classmethod descriptor. */
PyDosObj far * PYDOS_API pydos_builtin_bind_method(int argc,
                                                   PyDosObj far * far *argv);
PyDosObj far * PYDOS_API pydos_builtin_vars(int argc, PyDosObj far * far *argv);

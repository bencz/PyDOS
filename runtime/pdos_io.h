...
/* File close. Returns 0 on success or -1 on a DOS error. */
...
/* Python-facing handle primitives.  Stream lifecycle, buffering and public
 * open() policy live in stdlib/pydos/io/base.py, text.py and files.py. */

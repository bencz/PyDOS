...
/* The polymorphic binary-operator family (add/sub/mul/div/mod/pow/
 * matmul/bitwise/shift/inplace and the instance-dunder dispatcher)
 * lives in pdos_ops.c: this module's code segment is at the 64 KB
 * large-model limit. */

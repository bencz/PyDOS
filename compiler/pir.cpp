...
static const char *op_names[] = {
    ...
    "guarded_call_method", /* PIR_GUARDED_CALL_METHOD */
    ...
    "check_exception",  /* PIR_CHECK_EXCEPTION */
    "clear_exception",  /* PIR_CLEAR_EXCEPTION */
    "panic_exception",  /* PIR_PANIC_EXCEPTION */
...
{
    PIRModule *m = new PIRModule;
    if (!m) {
        fprintf(stderr, "pir: out of memory allocating module\n");
        exit(1);
    }
    memset(m->vtables, 0, sizeof(m->vtables));
    m->init_func = 0;
    m->num_vtables = 0;
    m->module_name = 0;
    m->is_main_module = 1;

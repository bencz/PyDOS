...
struct ASTNode {
    ...
    union {
        ...
        struct {
            ...
            ASTNode **type_param_bounds;   /* bound or constraint tuple */
            unsigned char *type_param_kinds; /* 0 TypeVar, 1 *Ts, 2 **P */
            int num_type_params;
        ...
        struct {
            ...
            ASTNode *metaclass;      /* explicit metaclass= expression */
            ASTNode *keywords;       /* additional class keyword arguments */
            ASTNode *body;
            ASTNode *decorators;
            const char **type_param_names; /* type parameter names e.g. ["T"] */
            ASTNode **type_param_bounds;
            unsigned char *type_param_kinds;
            int num_type_params;
            const char *generic_origin;    /* set on monomorphized copies */
        } class_def;

 ...
 * Replaces PIR_CALL_METHOD with PIR_GUARDED_CALL_METHOD when the object's
 * class type is known and the method exists in the C3 hierarchy.  Runtime
 * validation falls back to ordinary lookup after class/instance mutation.

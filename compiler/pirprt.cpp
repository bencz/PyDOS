...
static void print_inst(PIRInst *inst, FILE *out)
{
    ...
    case PIR_CALL:
        ...
        fprintf(out, " argc=%ld", inst->int_val);
        break;
    ...
    case PIR_GUARDED_CALL_METHOD:
        ...
        fprintf(out, " argc=%ld", inst->int_val);
        if (inst->op == PIR_GUARDED_CALL_METHOD && inst->guard_target)
            fprintf(out, " guard=@%s", inst->guard_target);
        break;
    ...
    case PIR_ALLOC_OBJ:
        if (inst->int_val) {
            fprintf(out, " type=%ld", inst->int_val);
        }
        break;

    case PIR_INIT_VTABLE:
        fprintf(out, " vtable=%ld", inst->int_val);
        break;
    ...
    case PIR_CHECK_VTABLE:
        ...
        if (inst->str_val) {
            ...
            fprintf(out, " isinstance vtable=%ld", inst->int_val);
        }
        break;
    ...
    case PIR_MAKE_COROUTINE:
        ...
        fprintf(out, " locals=%ld", inst->int_val);
        break;
    ...
    case PIR_GEN_SET_PC:
        fprintf(out, " ");
        print_val(inst->operands[0], out);
        fprintf(out, " state=%ld", inst->int_val);
        break;

...
public:
    ...
    virtual void emit_builtin_pir_method_registrations();
    ...
    virtual void emit_check_exception(IRInstr *instr);
    virtual void emit_clear_exception(IRInstr *instr);
    virtual void emit_panic_exception(IRInstr *instr);
...
private:
    ...
    int *scope_temps;
    int scope_temp_count;
    IRInstr **loop_scope_tracks;
    int loop_scope_track_count;
    int scope_map_id;
    int next_scope_map_id;
    int *exception_stub_handlers;
    int *exception_stub_labels;
    int *exception_stub_lines;
    int exception_stub_count;
    int exception_stub_capacity;
    ...
    /* Semantic call-site marker.  Calls restore DS automatically. */
    ...
    int get_exception_stub(int handler_label, int line);
    void emit_exception_stubs(IRFunc *func);
};

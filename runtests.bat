...
call runone.bat cmp_dbg %MODE%
if exist _TESTOK echo cmp_dbg>>_PASSED.TMP
if not exist _TESTOK echo cmp_dbg>>_FAILED.TMP
...
call runone.bat tryret %MODE%
if exist _TESTOK echo tryret>>_PASSED.TMP
if not exist _TESTOK echo tryret>>_FAILED.TMP
call runone.bat flowcln %MODE%
if exist _TESTOK echo flowcln>>_PASSED.TMP
if not exist _TESTOK echo flowcln>>_FAILED.TMP
...
call runone.bat gen_fold %MODE%
if exist _TESTOK echo gen_fold>>_PASSED.TMP
if not exist _TESTOK echo gen_fold>>_FAILED.TMP
...
call runone.bat genexpr %MODE%
if exist _TESTOK echo genexpr>>_PASSED.TMP
if not exist _TESTOK echo genexpr>>_FAILED.TMP
...
call runone.bat mod_imp %MODE%
if exist _TESTOK echo mod_imp>>_PASSED.TMP
if not exist _TESTOK echo mod_imp>>_FAILED.TMP
...
call runone.bat str_312 %MODE%
if exist _TESTOK echo str_312>>_PASSED.TMP
if not exist _TESTOK echo str_312>>_FAILED.TMP
...
call runone.bat withret %MODE%
if exist _TESTOK echo withret>>_PASSED.TMP
if not exist _TESTOK echo withret>>_FAILED.TMP
...
call runone.bat bya_312 %MODE%
if exist _TESTOK echo bya_312>>_PASSED.TMP
if not exist _TESTOK echo bya_312>>_FAILED.TMP

call runone.bat int_312 %MODE%
if exist _TESTOK echo int_312>>_PASSED.TMP
if not exist _TESTOK echo int_312>>_FAILED.TMP

call runone.bat flt_312 %MODE%
if exist _TESTOK echo flt_312>>_PASSED.TMP
if not exist _TESTOK echo flt_312>>_FAILED.TMP

call runone.bat blt_312 %MODE%
if exist _TESTOK echo blt_312>>_PASSED.TMP
if not exist _TESTOK echo blt_312>>_FAILED.TMP

call runone.bat range312 %MODE%
if exist _TESTOK echo range312>>_PASSED.TMP
if not exist _TESTOK echo range312>>_FAILED.TMP

call runone.bat core312 %MODE%
if exist _TESTOK echo core312>>_PASSED.TMP
if not exist _TESTOK echo core312>>_FAILED.TMP

call runone.bat decor312 %MODE%
if exist _TESTOK echo decor312>>_PASSED.TMP
if not exist _TESTOK echo decor312>>_FAILED.TMP

call runone.bat abc312 %MODE%
if exist _TESTOK echo abc312>>_PASSED.TMP
if not exist _TESTOK echo abc312>>_FAILED.TMP

call runone.bat descr312 %MODE%
if exist _TESTOK echo descr312>>_PASSED.TMP
if not exist _TESTOK echo descr312>>_FAILED.TMP

call runone.bat bdesc312 %MODE%
if exist _TESTOK echo bdesc312>>_PASSED.TMP
if not exist _TESTOK echo bdesc312>>_FAILED.TMP

call runone.bat mro312 %MODE%
if exist _TESTOK echo mro312>>_PASSED.TMP
if not exist _TESTOK echo mro312>>_FAILED.TMP

call runone.bat call312 %MODE%
if exist _TESTOK echo call312>>_PASSED.TMP
if not exist _TESTOK echo call312>>_FAILED.TMP

call runone.bat meta312 %MODE%
if exist _TESTOK echo meta312>>_PASSED.TMP
if not exist _TESTOK echo meta312>>_FAILED.TMP

call runone.bat maxkey %MODE%
if exist _TESTOK echo maxkey>>_PASSED.TMP
if not exist _TESTOK echo maxkey>>_FAILED.TMP

call runone.bat proto312 %MODE%
if exist _TESTOK echo proto312>>_PASSED.TMP
if not exist _TESTOK echo proto312>>_FAILED.TMP

call runone.bat matrix %MODE%
if exist _TESTOK echo matrix>>_PASSED.TMP
if not exist _TESTOK echo matrix>>_FAILED.TMP

call runone.bat dclass312 %MODE%
...
call runone.bat mthclos %MODE%
if exist _TESTOK echo mthclos>>_PASSED.TMP
if not exist _TESTOK echo mthclos>>_FAILED.TMP
call runone.bat callfrm %MODE%
if exist _TESTOK echo callfrm>>_PASSED.TMP
if not exist _TESTOK echo callfrm>>_FAILED.TMP
call runone.bat nstname %MODE%
if exist _TESTOK echo nstname>>_PASSED.TMP
if not exist _TESTOK echo nstname>>_FAILED.TMP
call runone.bat clsrdep %MODE%
if exist _TESTOK echo clsrdep>>_PASSED.TMP
if not exist _TESTOK echo clsrdep>>_FAILED.TMP
call runone.bat richcmp %MODE%
if exist _TESTOK echo richcmp>>_PASSED.TMP
if not exist _TESTOK echo richcmp>>_FAILED.TMP
call runone.bat genproto %MODE%
if exist _TESTOK echo genproto>>_PASSED.TMP
if not exist _TESTOK echo genproto>>_FAILED.TMP
call runone.bat genloop %MODE%
if exist _TESTOK echo genloop>>_PASSED.TMP
if not exist _TESTOK echo genloop>>_FAILED.TMP
call runone.bat genxfrm %MODE%
if exist _TESTOK echo genxfrm>>_PASSED.TMP
if not exist _TESTOK echo genxfrm>>_FAILED.TMP
call runone.bat mangling %MODE%
if exist _TESTOK echo mangling>>_PASSED.TMP
if not exist _TESTOK echo mangling>>_FAILED.TMP
call runone.bat manglep2 %MODE%
if exist _TESTOK echo manglep2>>_PASSED.TMP
if not exist _TESTOK echo manglep2>>_FAILED.TMP
call runone.bat manglepy %MODE%
if exist _TESTOK echo manglepy>>_PASSED.TMP
if not exist _TESTOK echo manglepy>>_FAILED.TMP

call runone.bat file312 %MODE%
if exist _TESTOK echo file312>>_PASSED.TMP
if not exist _TESTOK echo file312>>_FAILED.TMP
call runone.bat open312 %MODE%
if exist _TESTOK echo open312>>_PASSED.TMP
if not exist _TESTOK echo open312>>_FAILED.TMP

call runone.bat catmodel %MODE%
if exist _TESTOK echo catmodel>>_PASSED.TMP
if not exist _TESTOK echo catmodel>>_FAILED.TMP

call runone.bat editmodel %MODE%
if exist _TESTOK echo editmodel>>_PASSED.TMP
if not exist _TESTOK echo editmodel>>_FAILED.TMP

call runone.bat arndep %MODE%
if exist _TESTOK echo arndep>>_PASSED.TMP
if not exist _TESTOK echo arndep>>_FAILED.TMP

call runone.bat tp_byt %MODE%
if exist _TESTOK echo tp_byt>>_PASSED.TMP
if not exist _TESTOK echo tp_byt>>_FAILED.TMP
...
call runone.bat col_312 %MODE%
if exist _TESTOK echo col_312>>_PASSED.TMP
if not exist _TESTOK echo col_312>>_FAILED.TMP

call runone.bat gc312 %MODE%
if exist _TESTOK echo gc312>>_PASSED.TMP
if not exist _TESTOK echo gc312>>_FAILED.TMP

call runone.bat gcstress %MODE%
if exist _TESTOK echo gcstress>>_PASSED.TMP
if not exist _TESTOK echo gcstress>>_FAILED.TMP
